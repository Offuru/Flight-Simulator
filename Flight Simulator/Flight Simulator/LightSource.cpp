	...
	m_lightVAO{ VAO() }, m_lightVBO{ VBO() }, m_lightEBO{ EBO() }
{
	...
	m_lightVAO.LinkAttribute(m_lightVBO, 0, 3, GL_FLOAT, 8 * sizeof(GLfloat), nullptr);
	m_lightVAO.LinkAttribute(m_lightVBO, 1, 3, GL_FLOAT, 8 * sizeof(GLfloat), (void*)(3 * sizeof(GLfloat)));
