...
void Skybox::Render(Shader& shader, Camera* camera, Plane& plane)
{
...
void Skybox::LoadCube()
{
    ...
    vao.LinkAttribute(vbo, 0, 3, GL_FLOAT, 3 * sizeof(GLfloat), (void*)0);
    vbo.Unbind();
    vao.Unbind();
}

GLuint Skybox::LoadCubeMap(const std::string& path)
{
